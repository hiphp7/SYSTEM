...
<?php
	if($_POST["submit"])
	{
		...
		$sql="update system set name='$name',title='$title',keywords='$keywords',smalltext='$smalltext',url='$url',copyright='$copyright'";
		mysql_query($sql);
...
<form action="" method="post" name="60ie" id="60ie">
			<table width="100%" border=0 align=center cellpadding=5 cellspacing=1 class="table">
				...
				<tr>
				  ...
				  (网站域名 后面带<span class="reds">'/</span>' 如：http://www.04ie.com/)</td>
				</tr>                
				<tr>
					...
					<td class="td_bg">
					<label>
					<textarea name="copyright" cols="65" rows="4" id="copyright"><?php echo $rows["copyright"];?></textarea>
					</label></td>
				</tr>
				<tr>
